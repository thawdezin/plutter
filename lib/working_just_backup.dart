...
//   double _scale = 1.0; // Added scale state variable
//
...
//       _dragOffset = 0.0;
//       _scale = 1.0; // Reset scale when selected index changes
//     }
//   }
//
...
//         // This GestureDetector will handle horizontal dragging for the entire nav bar
...
//             setState(() => _scale = 1.05), // Increase scale on drag start
...
//           setState(() {
//             _dragOffset = 0;
//             _scale = 1.0; // Restore scale on drag end
//           });
//         },
//         child: SizedBox(
//           height: pillH,
...
//                 height: pillH + 10,
//                 child: GestureDetector(
//                   // This GestureDetector specifically handles long press on the pill
//                   onLongPressStart: (_) =>
//                       setState(() => _scale = 1.1), // Increase scale on long press start
//                   onLongPressEnd: (_) =>
//                       setState(() => _scale = 1.0), // Restore scale on long press end
